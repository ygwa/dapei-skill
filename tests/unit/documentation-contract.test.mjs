...
'cdr.profile', 'cdr.bootstrap', 'cdr.entries', 'cdr.domain', 'cdr.capability', 'cdr.index', 'cdr.doc', 'cdr.behavior', 'cdr.state', 'cdr.business', 'cdr.query', 'cdr.pipeline', 'cdr.feature'
  ]);
